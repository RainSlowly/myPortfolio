...
export class LanguageService {
  ...
  italian={
    ...
    proj2Utilized:"<b>Fatto con:</b>Javascript e CSS", proj2Description:'Una settimana dopo aver studiato Javascript ho iniziato questo <b>primo progetto</b> imparando a programmare parallelamente alla sua edificazione.In circa quindici giorni ho creato un giochino <b>one page</b> basato sulli&#39;uso di <b>finestre modali</b> che emula lo stile di un browser game anni 2000/10.I dati sono <b>mockati</b> alli&#39;interno dello script in array di oggetti che tengono conto dei pokemon, delle loro statistiche e delle loro possibili mosse. La gestione delle musiche, dei suoni e delle animazioni è molto basilare ma fa il suo lavoro, con funzioni più complesse create per la gestione delli&#39; <b>IA</b> delli&#39;avversario.<br>Il gioco permette anche di far evolvere i pokémon e smistarli in box con semplicità <br> grazie ai <b>drag and drop</b>.<br> Questo progetto, seppur il mio primo, mi ha insegnato tantissimo ed è come il primo amore:<br> Non si scorda mai.',
    ...
    proj5Description:"Questa web app consente agli utenti di creare e personalizzare personaggi per giochi di ruolo testuali, interagendo tramite un sistema di chat in tempo reale. Il backend, sviluppato in Node.js, è leggero ma efficiente, grazie a un'attenta OOP e tecniche di ottimizzazione come il lazy loading e il recupero mirato dei dati. Le route guard gestiscono i ruoli degli utenti, offrendo funzionalità esclusive per Game Masters e creatori di abilità. Il sistema di gestione degli ID garantisce ordine e scalabilità nel database. La grafica e le animazioni, curate interamente da me con Photoshop e CSS, lo fanno sembrare un vero gioco per smartphone, riprendendo l’atmosfera dei classici giochi di ruolo via chat o forum degli anni 2000, ma in chiave moderna e multipiattaforma grazie ai media query. Un progetto complesso, a cui ho dedicato molte ore, e di cui sono estremamente orgoglioso.",resumeEdu:"Titolo di Studio:",resumeEdu2:"Diploma Scientifico",resumeLang:"Lingue",resumeLang2:"Italiano - Inglese <span>(C1)</span>", resumeSkill1:"Apprendimento Rapido",resumeSkill2:"Multipotenziale", resumeSkill3:"Lavoro di Squadra",
  ...
  english={   
    ...
    proj5Description:"This web app allows users to create and customize characters for text-based role-playing games, interacting through a real-time chat system. The Node.js backend is lightweight yet efficient, leveraging OOP principles and optimization techniques such as lazy loading and targeted data retrieval. Route guards manage user roles, providing exclusive features for Game Masters and skill creators. A structured ID management system ensures database order and scalability. The UI and animations, designed entirely by me using Photoshop and CSS, make it feel like a true smartphone game, inspired by classic forum and chat-based RPGs from the 2000s but reimagined in a modern, cross-platform way using media queries. A complex project that took countless hours, but one I’m truly proud of.",
    resumeEdu: "Education:",
  ...
  balloonIta={
    ...
    project5:"Adoro i GDR, ci sono cresciuto. In questo puoi anche parlare con NPC gestiti dall'AI! Forte!",
  ...
  balloonEng={
    aboutLocked:"Hi! I'm <b>Simone</b>, this is my portfolio site.<br> I'll be your guide here.<br> Even if something is still in WIP.",
    ...
    project5:"I love RPGs —I grew up with them. In this one, you can even chat with AI-controlled NPCs! Cool!",
